...
export function DataControlPanel() {
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 text-sm">
      <h3 className="text-base font-semibold text-slate-100">Offline data control</h3>
      <p className="mt-1 text-xs text-slate-500">Export encrypted backups or import data on any device.</p>
