      ...
      <div key={detail.item.id} className={`${rowClass} ${rowStateClass}`}>
        <div className="min-w-0 space-y-2" style={{ paddingLeft: depth * 20 }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-slate-400">{Math.round(progressPercent)}%</span>
          </div>
          {isEditing && (
            <div className="pt-1">
          ...
          <div className="space-y-4">
            ...
            {visibleUncategorisedDetails.length > 0 && (
              <div className="overflow-hidden rounded-2xl border border-warning/40 bg-warning/5">
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-warning/30 bg-warning/10 px-4 py-3 text-[11px] font-semibold uppercase tracking-wide text-warning">
                  <span>Uncategorised planned expenses</span>
                  <span>
                    {visibleUncategorisedDetails.length} item
                    {visibleUncategorisedDetails.length === 1 ? '' : 's'} awaiting category
                  </span>
                </div>
                <div className="overflow-x-auto">
                  <div className="min-w-[980px] text-xs">
